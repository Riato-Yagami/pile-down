...
PILE_DOWN_JAVA_HOME="${PILE_DOWN_JAVA_HOME:-/usr/lib/jvm/java-17-openjdk}"
PILE_DOWN_ANDROID_SDK="${PILE_DOWN_ANDROID_SDK:-${HOME}/Android/Sdk}"
...
if [[ ! -x "${PILE_DOWN_JAVA_HOME}/bin/java" ]]; then
	echo "Java SDK not found at: ${PILE_DOWN_JAVA_HOME}" >&2
	echo "You can override it with PILE_DOWN_JAVA_HOME." >&2
	exit 1
fi
...
export ANDROID_SDK_ROOT="${PILE_DOWN_ANDROID_SDK}"
