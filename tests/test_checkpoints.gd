...
func _run() -> void:
	...
	assert(game.overlay_unlocks.text.contains("NEW CHECKPOINTS:"))
	assert(game.overlay_unlocks.text.contains("1 AND 5"))
	game.newly_unlocked_checkpoints.assign([1])
	game._append_new_checkpoint_summary()
	assert(game.overlay_unlocks.text.contains("NEW CHECKPOINT: 1"))
	assert(not game.overlay_unlocks.text.contains("NEW CHECKPOINTS"))
	...
	assert(game.overlay_unlocks.text.contains("NEW PROGRESSION"))
	assert(game.overlay_unlocks.text.contains("NEW BONUSES: OPEN BOOK"))
	assert(game.overlay_unlocks.text.contains("NEW RULES: SHELL GAME"))
	assert(game.overlay_unlocks.text.contains("NEW ACHIEVEMENTS: STACK OVERFLOW"))
	...
	assert(game.progression_menu._page_badges[ProgressionMenu.Page.HIGHSCORES].visible)
	...
	assert(game.progression_notification.visible)
	game.progression_menu.page_buttons[ProgressionMenu.Page.HIGHSCORES].pressed.emit()
