...
func _init() -> void:
	...
	assert(game.splash_button.has_meta(&"ui_click_sound_connected"))
	assert(game.progression_button.has_meta(&"ui_click_sound_connected"))
	assert(game.back_button.has_meta(&"ui_click_sound_connected"))
	assert(not game.pause_seed_display.copy_button.has_meta(&"ui_click_sound_connected"))
